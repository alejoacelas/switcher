...
This is the active AltTab **⌘Tab** setup captured on 2026-07-12.

- Trigger: hold ⌘, press Tab; release ⌘ to focus.
- Items: one main window per app, across every Space and screen, recently focused first.
...
- Appearance: compact medium thumbnail tiles, 47% container opacity, large primary icons with no corner icon, only the selected window's centered middle-truncated title in a separate row, 100 ms delay, no menu-bar icon.
