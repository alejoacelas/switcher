...
- Appearance: compact medium tiles with large app icons, 47% container opacity, only the selected window's centered middle-truncated title in a separate row, 100 ms delay, no menu-bar icon.
